...
export declare class EmbeddedNamespaceMetadataTransactionBuilder extends EmbeddedTransactionBuilder {
    namespaceMetadataTransactionBody: NamespaceMetadataTransactionBodyBuilder;
    constructor(signerPublicKey: KeyDto, version: number, network: NetworkTypeDto, type: EntityTypeDto, targetPublicKey: KeyDto, scopedMetadataKey: number[], targetNamespaceId: NamespaceIdDto, valueSizeDelta: number, value: Uint8Array);
