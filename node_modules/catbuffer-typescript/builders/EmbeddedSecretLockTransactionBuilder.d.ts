...
export declare class EmbeddedSecretLockTransactionBuilder extends EmbeddedTransactionBuilder {
    secretLockTransactionBody: SecretLockTransactionBodyBuilder;
    constructor(signerPublicKey: KeyDto, version: number, network: NetworkTypeDto, type: EntityTypeDto, secret: Hash256Dto, mosaic: UnresolvedMosaicBuilder, duration: BlockDurationDto, hashAlgorithm: LockHashAlgorithmDto, recipientAddress: UnresolvedAddressDto);
