...
class NodeHttp extends Http_1.Http {
    ...
    constructor(url) {
        super(url);
        this.nodeRoutesApi = new symbol_openapi_typescript_node_client_1.NodeRoutesApi(url);
     ...
     */
    toNodeInfo(nodeInfo) {
        return new NodeInfo_1.NodeInfo(nodeInfo.publicKey, nodeInfo.networkGenerationHash, nodeInfo.port, nodeInfo.networkIdentifier, nodeInfo.version, nodeInfo.roles, nodeInfo.host, nodeInfo.friendlyName);
    }
}
