...
class PersistentHarvestingDelegationMessage extends Message_1.Message {
     ...
     */
    static create(delegatedPrivateKey, recipientPublicKey, networkType) {
        ...
        const encrypted = MessageMarker_1.MessageMarker.PersistentDelegationUnlock +
            ...
            crypto_1.Crypto.encode(ephemeralKeypair.privateKey, recipientPublicKey, delegatedPrivateKey, true).toUpperCase();
