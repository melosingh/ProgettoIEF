...
class BalanceTransferReceipt extends Receipt_1.Receipt {
     ...
     */
    serialize() {
        return new catbuffer_typescript_1.BalanceTransferReceiptBuilder(ReceiptVersion_1.ReceiptVersion.BALANCE_TRANSFER, this.type.valueOf(), new catbuffer_typescript_1.MosaicBuilder(new catbuffer_typescript_1.MosaicIdDto(this.mosaicId.toDTO()), new catbuffer_typescript_1.AmountDto(this.amount.toDTO())), new catbuffer_typescript_1.KeyDto(Convert_1.Convert.hexToUint8(this.sender.publicKey)), new catbuffer_typescript_1.AddressDto(this.getRecipientBytes())).serialize();
    }
    /**
     * @internal
