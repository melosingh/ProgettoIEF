...
class Statement {
    ...
    getResolvedFromReceipt(resolutionType, unresolved, transactionIndex, height, aggregateTransactionIndex) {
        const resolutionStatement = (resolutionType === ResolutionType_1.ResolutionType.Address
            ? this.addressResolutionStatements
            : this.mosaicResolutionStatements).find((resolution) => resolution.height.toString() === height && resolution.unresolved.equals(unresolved));
