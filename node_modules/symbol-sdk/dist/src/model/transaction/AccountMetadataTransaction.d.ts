...
export declare class AccountMetadataTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, targetPublicKey: string, scopedMetadataKey: UInt64, valueSizeDelta: number, value: string, networkType: NetworkType, maxFee?: UInt64): AccountMetadataTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
