...
class AccountMosaicRestrictionTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, restrictionFlags, restrictionAdditions, restrictionDeletions, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        return new AccountMosaicRestrictionTransaction(networkType, TransactionVersion_1.TransactionVersion.ACCOUNT_MOSAIC_RESTRICTION, deadline, maxFee, restrictionFlags, restrictionAdditions, restrictionDeletions);
    }
    /**
