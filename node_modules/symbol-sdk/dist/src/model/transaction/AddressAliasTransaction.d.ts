...
export declare class AddressAliasTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, aliasAction: AliasAction, namespaceId: NamespaceId, address: Address, networkType: NetworkType, maxFee?: UInt64): AddressAliasTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
