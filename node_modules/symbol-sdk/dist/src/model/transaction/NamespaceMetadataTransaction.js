...
class NamespaceMetadataTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, targetPublicKey, scopedMetadataKey, targetNamespaceId, valueSizeDelta, value, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        return new NamespaceMetadataTransaction(networkType, TransactionVersion_1.TransactionVersion.NAMESPACE_METADATA, deadline, maxFee, targetPublicKey, scopedMetadataKey, targetNamespaceId, valueSizeDelta, value);
    }
    /**
    ...
    static createFromPayload(payload, isEmbedded = false) {
        ...
        const transaction = NamespaceMetadataTransaction.create(isEmbedded
            ...
            : Deadline_1.Deadline.createFromDTO(builder.getDeadline().timestamp), format_1.Convert.uint8ToHex(builder.getTargetPublicKey().key), new UInt64_1.UInt64(builder.getScopedMetadataKey()), new NamespaceId_1.NamespaceId(builder.getTargetNamespaceId().namespaceId), builder.getValueSizeDelta(), format_1.Convert.uint8ToUtf8(builder.getValue()), networkType, isEmbedded ? new UInt64_1.UInt64([0, 0]) : new UInt64_1.UInt64(builder.fee.amount));
