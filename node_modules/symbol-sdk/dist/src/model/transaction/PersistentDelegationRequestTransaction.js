...
class PersistentDelegationRequestTransaction extends TransferTransaction_1.TransferTransaction {
     ...
     */
    static createPersistentDelegationRequestTransaction(deadline, delegatedPrivateKey, recipientPublicKey, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        const message = PersistentHarvestingDelegationMessage_1.PersistentHarvestingDelegationMessage.create(delegatedPrivateKey, recipientPublicKey, networkType);
        return super.create(deadline, Address_1.Address.createFromPublicKey(recipientPublicKey, networkType), [], message, networkType, maxFee);
    }
}
