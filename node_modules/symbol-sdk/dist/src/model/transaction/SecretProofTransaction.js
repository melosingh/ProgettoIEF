...
class SecretProofTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, hashAlgorithm, secret, recipientAddress, proof, networkType, maxFee = new UInt64_1.UInt64([0, 0])) {
        return new SecretProofTransaction(networkType, TransactionVersion_1.TransactionVersion.SECRET_PROOF, deadline, maxFee, hashAlgorithm, secret, recipientAddress, proof);
    }
    /**
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedSecretProofTransactionBuilder(new catbuffer_typescript_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.SECRET_PROOF.valueOf(), new catbuffer_typescript_1.Hash256Dto(this.getSecretByte()), this.hashAlgorithm.valueOf(), new catbuffer_typescript_1.UnresolvedAddressDto(UnresolvedMapping_1.UnresolvedMapping.toUnresolvedAddressBytes(this.recipientAddress, this.networkType)), this.getProofByte());
    }
    /**
     * @internal
