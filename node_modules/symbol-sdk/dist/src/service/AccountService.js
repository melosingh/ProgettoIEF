...
class AccountService {
     ...
     */
    accountNamespacesWithName(addresses) {
        return this.namespaceRepository.getNamespacesFromAccounts(addresses).pipe(operators_2.mergeMap((infos) => {
            const namespaceIds = infos.map((i) => i.id);
            return this.namespaceRepository.getNamespacesName(namespaceIds).pipe(operators_1.map((resolved) => {
                return infos.map((info) => {
