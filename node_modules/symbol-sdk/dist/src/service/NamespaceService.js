...
class NamespaceService {
     ...
     */
    namespace(id) {
        return this.namespaceRepository.getNamespace(id).pipe(operators_1.mergeMap((namespaceInfo) => this.namespaceRepository.getNamespacesName(namespaceInfo.levels).pipe(operators_1.map((names) => Object.assign({
